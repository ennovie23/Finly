...
function App() {
  ...
  const [email, setEmail] = useState(() => localStorage.getItem("spendsight_email") || "");
  const [password, setPassword] = useState("");
  const [isHovered, setIsHovered] = useState(false);
  const [isLoggedIn, setIsLoggedIn] = useState(() => localStorage.getItem("spendsight_isLoggedIn") === "true");
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              boxShadow: isHovered ? "0px 4px 20px rgba(0, 229, 255, 0.6)" : "none",
            }}
          >
            Login ➔
          </button>
        ...
        <div style={{ display: "flex", alignItems: "center", margin: "24px 0", color: "#718096" }}>
          <div style={{ flex: 1, height: "1px", backgroundColor: "#1b2135" }}></div>
          <span style={{ padding: "0 10px", fontSize: "12px", textTransform: "uppercase", letterSpacing: "1px" }}>or</span>
          <div style={{ flex: 1, height: "1px", backgroundColor: "#1b2135" }}></div>
        </div>
